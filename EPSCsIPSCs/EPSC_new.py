...
#In order to make certain functions work, certain data has to be identified as 'e' (for epsc) or 'i' (for ipsc) in the console. 
#For example, in order to plot EPSCs, type: e = plot_data_epsc()
